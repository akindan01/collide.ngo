    ...
    <>
      ...
      <section id="home" className="relative overflow-hidden min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] lg:min-h-screen">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 flex items-center h-full">
          ...
          >
            <p className="text-white text-3sm font-semibold pt-12 md:mt-20 pl-2 tracking-wide">Give them a chance.</p>
...
<section id="events" className="py-20 bg-white">
      ...
      <section id="contact" className="py-8 md:py-0 bg-gray-50 mt-2">
